...
//   KUGELAUDIO_Q8_MODEL -> q8_0 gguf
//   KUGELAUDIO_TOKENIZER            -> tokenizer gguf
//   KUGELAUDIO_REF_WAV              -> 24 kHz mono reference wav
...
int main() {
    ...
    if (!file_ok(model_path) || !file_ok(tok_path) || !file_ok(ref_wav)) {
        std::fprintf(stderr,
            "skip: KugelAudio q8_0 smoke test needs KUGELAUDIO_Q8_MODEL + KUGELAUDIO_TOKENIZER + KUGELAUDIO_REF_WAV\n");
        return 77;
    }
