...
SCRIPT = ROOT / "scripts" / "convert_kugelaudio_to_gguf.py"
SPEC = importlib.util.spec_from_file_location("convert_kugelaudio_to_gguf", SCRIPT)
...
class ConverterTests(unittest.TestCase):
    ...
    def test_convert_emits_explicit_kugelaudio_metadata_contract(self):
        ...
        self.assertEqual(writer.arch, "kugelaudio")
